...
export const nordTheme: ColorTheme = {
  ...
  usageLimit: { bg: "#5e81ac", fg: "#eceff4" },
  usageLimitWarning: { bg: "#d08770", fg: "#2e3440" },
};
...
export const nordAnsi256Theme: ColorTheme = {
  ...
  usageLimit: { bg: "#5f87d7", fg: "#ffffff" },
  usageLimitWarning: { bg: "#d7875f", fg: "#3a3a3a" },
};
...
export const nordAnsiTheme: ColorTheme = {
  ...
  usageLimit: { bg: "#0087ff", fg: "#ffffff" },
  usageLimitWarning: { bg: "#d78700", fg: "#000000" },
};
